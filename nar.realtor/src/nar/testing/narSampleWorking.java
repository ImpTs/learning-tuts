...
public class narSampleWorking {
	static ProfilesIni profile = new ProfilesIni();
	static FirefoxProfile myprofile = profile.getProfile("FFX-eclipse-47");
	...
	@Test
	public void javaSampleMain() throws Exception {
		for (i = 0; i < 18; i++) {
	...
	public void roUserLoginMain() throws Exception {
		for (i = 0; i < 3; i++) {
			driver.get(coreUrl + "/");
			try {
